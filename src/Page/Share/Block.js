  ...
  return (
    <div className='grid grid-cols-1 gap-5 mx-5'>
      <div tabindex="0" class="collapse group">
        <div class="collapse-title bg-base-100 text-black  group-focus:bg-base-200 group-focus:text-black-content">
          <h2>How will you improve the performance of a React Application?</h2>
        </div>
        <div class="collapse-content bg-primary text-primary-content group-focus:bg-base-200 group-focus:text-black-content">
      ...
      <div tabindex="0" class="collapse group">
        ...
        <div class="collapse-content bg-primary text-primary-content group-focus:bg-base-200 group-focus:text-black-content">
          <p className='text-black'> Managing state in your React apps isn’t as simple as using useState or useReducer. Not only are there are a lot of different kinds of state, but there often dozens of ways of managing each kind. Which should you choose?
      ...
      <div tabindex="0" class="collapse group">
        ...
        <div class="collapse-content bg-primary text-primary-content group-focus:bg-base-200 group-focus:text-black -content">
          <p className='text-black'> When it comes to inheritance, JavaScript only has one construct: objects. Each object has a private property which holds a link to another object called its prototype. That prototype object has a prototype of its own, and so on until an object is reached with null as its prototype. By definition, null has no prototype, and acts as the final link in this prototype chain. It is possible to mutate any member of the prototype chain or even swap out the prototype at runtime, so concepts like static dispatching do not exist in JavaScript.</p>
        </div>
      </div>
      ...
      <div tabindex="0" class="collapse group">
        ...
        <div class="collapse-content bg-primary text-primary -content group-focus:bg-base-200 group-focus:text-black-content">
          <p className='text-black'>Unit testing is an important step in the development process, because if done correctly, it can help detect early flaws in code which may be more difficult to find in later testing stages.
      ...
      <div tabindex="0" class="collapse group">
        ...
        <div class="collapse-content bg-primary text-primary-content group-focus:bg-base-200 group-focus:text-black-content">
          <p className='text-black'>In the HTML code of search bar, we gave the input an id=”searchbar” and onkeyup we called, the function “search_animal”. onkeyup calls the function every time a key is released on the keyboard.
