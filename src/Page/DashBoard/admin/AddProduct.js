...
import addproduct from "../../../image/addproduct.png";
...
const AddProduct = () => {
  ...
  return (
    <div className=" bg-slate-100 h-full">
      <h2 className="text-xl font-bold text-secondary text-center py-12">
        {user?.displayName} add a new product{" "}
      </h2>
      <div className="sm:flex py-y">
        <div className="sm:w-1/3 space-y-10 w-full px-6">
          <motion.img
            animate={{
              y: 20,
            }}
        ...
        <form
          className="sm:w-1/2 w-full mx-auto p-6 bg-base-100 shadow-xl rounded-lg py-6 space-y-2"
