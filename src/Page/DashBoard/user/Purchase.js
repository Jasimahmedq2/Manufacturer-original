...
const Purchase = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://dull-puce-basket-clam-sari.cyclic.app/purchase/", {
      method: "POST",
      headers: {
          ...
          <div className="text-start lg:w-1/2">
            ...
            <div className="py-12 space-y-4">
              ...
              <p className="text-xl font-sans">
                ...
                elit. Aliquam est ab sint et laudantium quaerat nobis a in quia
                rerum, voluptate cumque quis voluptatum id quos, eos, corrupti
                harum accusamus?
              </p>
            </div>
          </div>
